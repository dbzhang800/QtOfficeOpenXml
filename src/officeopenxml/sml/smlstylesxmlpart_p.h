...
**
****************************************************************************/
#ifndef QTOFFICEOPENXML_SML_STYLESXMLPART_P_H
#define QTOFFICEOPENXML_SML_STYLESXMLPART_P_H
...
class StylesXmlPart : public Ooxml::AbstractFixedTypeXmlPart
{
public:
    StylesXmlPart(const QString &partName, Opc::Package *package);
...
#endif // QTOFFICEOPENXML_SML_STYLESXMLPART_P_H
